...
import {addToFavorites, getFromFavorites, removeFromFavorites} from './Storage';
import {getPageDate, getPageDescription, getPageImageUrl, getPageLocation, getPageTitle, getPageType, renderFavoritesButton} from './NTS';
...
const watchStorageChanges = () => {
    chrome.storage.onChanged.addListener((changes, area) => area == 'sync' && renderExtension());
}
